        ...
        <div className="flex h-full flex-col p-6 lg:p-8">
            ...
            <div className="mb-6">
                <div className="flex items-baseline gap-1">
                    ...
                    <span
                        className={`text-4xl font-extrabold tracking-tight ${plan.popular ? "text-white" : "text-white"
                            }`}
                    >
                        {plan.price}
                    </span>
            ...
            {/* Divider */}
            <div
                className={`mb-6 h-px ${plan.popular
                ...
                {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2.5 text-[14px]">
                        <Check
                            size={16}
                            weight="bold"
                            className={`mt-0.5 shrink-0 ${plan.popular ? "text-white" : "text-[#D4AF37]"
                                }`}
                        />
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className={`w-full rounded-full py-3 text-sm font-bold uppercase tracking-widest transition-shadow duration-300 ${plan.popular
